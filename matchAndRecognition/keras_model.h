...
public:
  ...
  virtual void read_from_image(cv::Mat image) {};
...
public:
  ...
  void read_from_image(cv::Mat image);
...
public:
  ...
  virtual unsigned int get_input_rows() const { return 0; } 
  virtual unsigned int get_input_cols() const { return 0; } 
